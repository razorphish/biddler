...
export class FacebookController {
  ...
  @UseFacebookAuth()
  @ApiOperation({
    summary: 'Sends user to facebook for logging in',
    description: 'Sends user to facebook server to be authenticated'
  })
  login() {
  ...
  @Get('callback')
  @ApiOperation({
    summary: 'Callback for facebook url',
    description: 'validates facebook'
  })
