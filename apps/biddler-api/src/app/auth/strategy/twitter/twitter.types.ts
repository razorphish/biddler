...
import { IStrategyOption, IStrategyOptionWithRequest, Profile } from 'passport-twitter';
...
export interface TwitterAuthModuleOptionsFactory {
  createModuleOptions(): Promise<TwitterAuthModuleOptions> | TwitterAuthModuleOptions;
}
