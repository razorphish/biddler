...
CREATE TABLE BIDDLER_IDM_DB.API_CLIENT (
  ...
  CLIENT_SECRET       VARCHAR(256) NULL COMMENT 'The password that allows your CLIENT ID to use OAuth 2.0 as an authentication method.',
  ...
  SALT                VARCHAR(255) NULL COMMENT 'Client secret key salt used to formulate access tokens',
