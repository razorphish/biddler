...
-- CREATE INDEX LKP_INFO_LKP_GRP_NAME_IDX USING HASH ON BIDDLER_DB.LKP_INFO (LKP_GRP_NAME);
...
CREATE TABLE BIDDLER_DB.ACNT_INFO (
  ...
  CONSTRAINT ACNT_INFO_FK FOREIGN KEY (STUS_LKP_ID) REFERENCES BIDDLER_DB.LKP_INFO(LKP_ID)
);
...
CREATE TABLE BIDDLER_DB.PERMSN_INFO (
  ...
  CONSTRAINT PERMSN_INFO_FK FOREIGN KEY (STUS_LKP_ID) REFERENCES BIDDLER_DB.LKP_INFO(LKP_ID)
) ;
...
CREATE TABLE BIDDLER_DB.ROLE_INFO (
  ...
  CONSTRAINT ROLE_INFO_FK FOREIGN KEY (STUS_LKP_ID) REFERENCES BIDDLER_DB.LKP_INFO(LKP_ID)
);

CREATE TABLE BIDDLER_DB.ADDR_INFO (
  ADR_ID          INT NOT NULL AUTO_INCREMENT,
  STUS_LKP_ID     VARCHAR(32) NOT NULL,
  ADR_TYPE_LKP_ID VARCHAR(32) NOT NULL,
  ...
  CONSTRAINT ADDR_INFO_FK   FOREIGN KEY (STUS_LKP_ID) REFERENCES BIDDLER_DB.LKP_INFO(LKP_ID),
  CONSTRAINT ADDR_INFO_FK_1 FOREIGN KEY (ADR_TYPE_LKP_ID) REFERENCES BIDDLER_DB.LKP_INFO(LKP_ID)
) ;
...
CREATE TABLE BIDDLER_DB.USER_INFO (
  ...
  CONSTRAINT USER_INFO_FK FOREIGN KEY (STUS_LKP_ID) REFERENCES BIDDLER_DB.LKP_INFO(LKP_ID)
) ;
...
CREATE TABLE BIDDLER_DB.ACNT_USER (
  ...
  CONSTRAINT ACNT_USER_FK_2 FOREIGN KEY (STUS_LKP_ID) REFERENCES BIDDLER_DB.LKP_INFO (LKP_ID)
);
...
CREATE TABLE BIDDLER_DB.ACNT_USER_ROLE (
  ...
  CONSTRAINT ACNT_USER_ROLE_FK_3  FOREIGN KEY (STUS_LKP_ID)  REFERENCES BIDDLER_DB.LKP_INFO  (LKP_ID)
) ;
...
CREATE TABLE BIDDLER_DB.ROLE_PERMSN (
  ...
  CONSTRAINT ROLE_PERMSN_FK_2 FOREIGN KEY (STUS_LKP_ID)  REFERENCES BIDDLER_DB.LKP_INFO (LKP_ID)
) ;