...
CREATE TABLE BIDDLER_DB.STUS_TYPE_LKP (
...
CREATE TABLE BIDDLER_DB.ACNT_INFO (
  ...
  CONSTRAINT ACNT_INFO_FK FOREIGN KEY (STUS_TYPE_CD) REFERENCES BIDDLER_DB.STUS_TYPE_LKP(STUS_TYPE_CD)
);
...
CREATE TABLE BIDDLER_DB.PERMSN_INFO (
  ...
  CONSTRAINT PERMSN_INFO_FK FOREIGN KEY (STUS_TYPE_CD) REFERENCES BIDDLER_DB.STUS_TYPE_LKP(STUS_TYPE_CD)
) ;
...
CREATE TABLE BIDDLER_DB.ROLE_INFO (
  ...
  CONSTRAINT ROLE_INFO_FK FOREIGN KEY (STUS_TYPE_CD) REFERENCES BIDDLER_DB.STUS_TYPE_LKP(STUS_TYPE_CD)
);

CREATE TABLE BIDDLER_DB.ADDR_TYPE_LKP (
...
CREATE TABLE BIDDLER_DB.ADDR_INFO (
  ...
  CONSTRAINT ADDR_INFO_FK   FOREIGN KEY (STUS_TYPE_CD) REFERENCES BIDDLER_DB.STUS_TYPE_LKP(STUS_TYPE_CD),
  CONSTRAINT ADDR_INFO_FK_1 FOREIGN KEY (ADDR_TYPE_CD) REFERENCES BIDDLER_DB.ADDR_TYPE_LKP(ADDR_TYPE_CD)
) ;
...
CREATE TABLE BIDDLER_DB.USER_INFO (
  ...
  CONSTRAINT USER_INFO_FK FOREIGN KEY (STUS_TYPE_CD) REFERENCES BIDDLER_DB.STUS_TYPE_LKP(STUS_TYPE_CD)
) ;
...
CREATE TABLE BIDDLER_DB.ACNT_USER_ROLE (
  ...
  CONSTRAINT ACNT_USER_ROLE_FK_3  FOREIGN KEY (STUS_TYPE_CD) REFERENCES BIDDLER_DB.STUS_TYPE_LKP (STUS_TYPE_CD)
) ;
...
CREATE TABLE BIDDLER_DB.ROLE_PERMSN (
  ...
  CONSTRAINT ROLE_PERMSN_FK_2 FOREIGN KEY (STUS_TYPE_CD)  REFERENCES BIDDLER_DB.STUS_TYPE_LKP (STUS_TYPE_CD)
) ;