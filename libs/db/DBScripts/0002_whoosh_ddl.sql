...
CREATE TABLE BIDDLER_DB.CAMPGN_GOAL_LKP (
  CAMPGN_GOAL_ID    INT auto_increment NOT NULL,
  STUS_TYPE_CD      VARCHAR(32)   NOT NULL,
  CAMPGN_GOAL_DESC  VARCHAR(128)  DEFAULT NULL,
...
CREATE TABLE BIDDLER_DB.CAMPGN_INFO (
  ...
  DLTD_AT         DATETIME NULL DEFAULT NULL, 
	...
	CONSTRAINT CAMPGN_INFO_FK FOREIGN KEY (USER_ID) REFERENCES BIDDLER_DB.USER_INFO(USER_ID),
	CONSTRAINT CAMPGN_INFO_FK_1 FOREIGN KEY (STUS_TYPE_CD) REFERENCES BIDDLER_DB.STUS_TYPE_LKP(STUS_TYPE_CD)
);
