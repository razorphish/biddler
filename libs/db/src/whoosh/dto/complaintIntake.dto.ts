...
export type CreateComplaintIntakeDTO = {
  // Foreign Keys
  dataSourceId: number;
  statusId: string;
...
export type UpdateComplaintIntakeDTO = Optional<
  CreateComplaintIntakeDTO,
  'statusId' | 'dataSourceId' | 'recordedDate'
>;

export type FilterComplaintIntakeDTO = {
  isActive?: boolean;
  isDeleted?: boolean;
